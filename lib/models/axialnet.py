...
from .utils import *
from .RowCol import RowAttention, ColAttention
from .SCNet import ConvTransBlock
import pdb
    ...
    def _forward_impl(self, x):
        ...
        for i in range(0,4):
            for j in range(0,4):
                ...
                # x1_p = self.layer1_p(x_p)    #[4,32,16,16]
                # print(x1.shape)
                x_p = self.CTB1(x_p)
